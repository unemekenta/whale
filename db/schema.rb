...
ActiveRecord::Schema[7.0].define(version: 2023_07_29_024019) do
  ...
  create_table "diaries_image_relations", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "diary_comments", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "diary_id", null: false
    t.text "content"
    t.datetime "created_at", null: false
  ...
  create_table "information_contents", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
